<%@ Page Title="Person Details" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="RandomSchool.Maintain.vPerson.Details" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>People - Details</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvPerson" runat="server"
            ItemType="RandomSchool.Models.Person" DataKeyNames="PersonId"
