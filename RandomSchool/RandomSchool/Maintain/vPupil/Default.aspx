<%@ Page Title="PupilList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="RandomSchool.Maintain.vPupil.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <scf:ScaffoldingFilterRepeater runat="server" ID="FilterRepeater" ModelName="RandomSchool.Models.Pupil, RandomSchool" ScaffoldFilterContainerId="">
    <ItemTemplate>
    ...
    <div>
        <asp:ListView id="lvPupil" runat="server"
			...
			ItemType="RandomSchool.Models.Pupil"
