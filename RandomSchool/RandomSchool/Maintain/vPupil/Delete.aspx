<%@ Page Title="PupilDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="RandomSchool.Maintain.vPupil.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this Pupil?</h3>
        <asp:FormView ID="fvPupil" runat="server"
            ItemType="RandomSchool.Models.Pupil" DataKeyNames="StudentId"
            ...
            <ItemTemplate>
				<fieldset id="fsName" class="form-horizontal">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<%#: Item.FirstParent != null ? Item.FirstParent.FirstName : "" %>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-2 text-right">
						...
						<div class="col-sm-4">
							<%#: Item.SecondParent != null ? Item.SecondParent.FirstName : "" %>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-2 text-right">
