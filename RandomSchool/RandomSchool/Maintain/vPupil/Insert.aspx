<%@ Page Title="PupilInsert" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.cs" Inherits="RandomSchool.Maintain.vPupil.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Pupils - Insert</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvPupil" runat="server"
            ItemType="RandomSchool.Models.Pupil" DefaultMode="Insert"
