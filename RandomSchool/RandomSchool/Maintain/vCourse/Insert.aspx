<%@ Page Title="CourseInsert" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.cs" Inherits="RandomSchool.Maintain.vCourse.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Courses - Insert</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvCourse" runat="server"
            ItemType="RandomSchool.Models.Course" DefaultMode="Insert"
