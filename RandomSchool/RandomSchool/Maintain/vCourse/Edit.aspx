<%@ Page Title="CourseEdit" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RandomSchool.Maintain.vCourse.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Courses - Edit</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvCourse" runat="server"
            ItemType="RandomSchool.Models.Course" DefaultMode="Edit" DataKeyNames="CourseId"
            ...
            <EditItemTemplate>
				...
				<fieldset id="fsLocation" class="form-horizontal">
					...
					<asp:DynamicControl Mode="Edit" 
						DataField="RoomId" 
						DataTypeName="RandomSchool.Models.Room" 
						DataTextField="Description" 
						DataValueField="id"
						UIHint="ForeignKey" runat="server" OnLoad="dcForeignKey_Load" />
					<asp:DynamicControl Mode="Edit" 
						DataField="DepartmentId" 
						DataTypeName="RandomSchool.Models.Department" 
						DataTextField="Name" 
