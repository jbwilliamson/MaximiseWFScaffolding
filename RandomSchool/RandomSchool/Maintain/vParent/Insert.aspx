<%@ Page Title="ParentInsert" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.cs" Inherits="RandomSchool.Maintain.vParent.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Parents - Insert</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvParent" runat="server"
            ItemType="RandomSchool.Models.Parent" DefaultMode="Insert"
