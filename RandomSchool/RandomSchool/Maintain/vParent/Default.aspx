<%@ Page Title="ParentList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="RandomSchool.Maintain.vParent.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <scf:ScaffoldingFilterRepeater runat="server" ID="FilterRepeater" ModelName="RandomSchool.Models.Parent, RandomSchool" ScaffoldFilterContainerId="">
    <ItemTemplate>
    ...
    <div>
        <asp:ListView id="lvParent" runat="server"
			...
			ItemType="RandomSchool.Models.Parent"
