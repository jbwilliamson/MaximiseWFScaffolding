<%@ Page Title="Teacher Details" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="RandomSchool.Maintain.vTeacher.Details" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Teachers - Details</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvTeacher" runat="server"
            ItemType="RandomSchool.Models.Teacher" DataKeyNames="TeacherId"
