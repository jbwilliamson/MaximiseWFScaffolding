<%@ Page Title="TeacherInsert" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.cs" Inherits="RandomSchool.Maintain.vTeacher.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Teachers - Insert</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvTeacher" runat="server"
            ItemType="RandomSchool.Models.Teacher" DefaultMode="Insert"
