<%@ Page Title="GradeList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="RandomSchool.Maintain.vGrade.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <scf:ScaffoldingFilterRepeater runat="server" ID="FilterRepeater" ModelName="RandomSchool.Models.Grade, RandomSchool" ScaffoldFilterContainerId="">
    <ItemTemplate>
    ...
    <div>
        <asp:ListView id="lvGrade" runat="server"
            DataKeyNames="id"
			ItemType="RandomSchool.Models.Grade"
