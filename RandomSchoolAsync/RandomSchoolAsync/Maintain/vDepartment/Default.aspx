<%@ Page Title="DepartmentList" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vDepartment.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <scf:ScaffoldingFilterRepeater runat="server" ID="FilterRepeater" ModelName="RandomSchoolAsync.Models.Department, RandomSchoolAsync" ScaffoldFilterContainerId="">
    <ItemTemplate>
    ...
    <div>
        <asp:ListView id="lvDepartment" runat="server"
			...
			ItemType="RandomSchoolAsync.Models.Department"
