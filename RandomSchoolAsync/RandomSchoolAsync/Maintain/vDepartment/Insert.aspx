<%@ Page Title="DepartmentInsert" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vDepartment.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Departments - Insert</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvDepartment" runat="server"
            ItemType="RandomSchoolAsync.Models.Department" DefaultMode="Insert"
