<%@ Page Title="DepartmentEdit" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vDepartment.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Departments - Edit</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvDepartment" runat="server"
            ItemType="RandomSchoolAsync.Models.Department" DefaultMode="Edit" DataKeyNames="DepartmentId"
            ...
            <EditItemTemplate>
				...
				<fieldset id="fsDetails" class="form-horizontal">
					...
					<asp:DynamicControl Mode="Edit" 
						...
						DataTypeName="RandomSchoolAsync.Models.Teacher" 
