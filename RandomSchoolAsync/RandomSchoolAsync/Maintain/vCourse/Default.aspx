<%@ Page Title="CourseList" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vCourse.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <scf:ScaffoldingFilterRepeater runat="server" ID="FilterRepeater" ModelName="RandomSchoolAsync.Models.Course, RandomSchoolAsync" ScaffoldFilterContainerId="">
    <ItemTemplate>
    ...
    <div>
        <asp:ListView id="lvCourse" runat="server"
			...
			ItemType="RandomSchoolAsync.Models.Course"
                ...
                <table class="table table-striped" title="Courses list view">
                    ...
                    <thead>
                        <tr runat="server" id="headerRow">
							<th><asp:LinkButton Text="Id" CommandName="Sort" CommandArgument="CourseId" runat="Server" />&nbsp;<span runat="server" class=""></span></th>
