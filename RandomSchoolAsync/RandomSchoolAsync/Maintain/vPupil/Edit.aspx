<%@ Page Title="PupilEdit" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vPupil.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Pupils - Edit</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvPupil" runat="server"
            ItemType="RandomSchoolAsync.Models.Pupil" DefaultMode="Edit" DataKeyNames="StudentId"
