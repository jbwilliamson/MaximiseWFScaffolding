<%@ Page Title="PersonInsert" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vPerson.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>People - Insert</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvPerson" runat="server"
            ItemType="RandomSchoolAsync.Models.Person" DefaultMode="Insert"
