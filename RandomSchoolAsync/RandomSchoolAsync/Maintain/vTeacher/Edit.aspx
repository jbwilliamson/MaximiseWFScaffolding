<%@ Page Title="TeacherEdit" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vTeacher.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Teachers - Edit</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvTeacher" runat="server"
            ItemType="RandomSchoolAsync.Models.Teacher" DefaultMode="Edit" DataKeyNames="TeacherId"
