<%@ Page Title="ParentDelete" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vParent.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this Parent?</h3>
        <asp:FormView ID="fvParent" runat="server"
            ItemType="RandomSchoolAsync.Models.Parent" DataKeyNames="ParentId"
