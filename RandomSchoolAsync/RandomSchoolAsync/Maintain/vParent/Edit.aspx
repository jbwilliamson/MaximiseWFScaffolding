<%@ Page Title="ParentEdit" Async="true" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RandomSchoolAsync.Maintain.vParent.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<h2>Parents - Edit</h2>
		<p>&nbsp;</p>
        <asp:FormView ID="fvParent" runat="server"
            ItemType="RandomSchoolAsync.Models.Parent" DefaultMode="Edit" DataKeyNames="ParentId"
