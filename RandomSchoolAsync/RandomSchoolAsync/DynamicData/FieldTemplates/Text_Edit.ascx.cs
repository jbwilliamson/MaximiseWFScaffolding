    ...
    public partial class Text_EditField : System.Web.DynamicData.FieldTemplateUserControl
    {
		...
		protected void Page_Init(object sender, EventArgs e) 
		{
            if (!IsPostBack)
            {
                ...
                StringLengthAttribute stringLengthAttr = Column.Attributes.OfType<StringLengthAttribute>().FirstOrDefault();
                ...
                if (stringLengthAttr != null)
                {
                    ...
                    if (stringLengthAttr.MaximumLength > 0 && Column.MaxLength == 0) {
