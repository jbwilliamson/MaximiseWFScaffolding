    ...
    public partial class Integer_EditField : System.Web.DynamicData.FieldTemplateUserControl 
	{
		...
		protected void Page_Init(object sender, EventArgs e) 
        {
			if (!IsPostBack)
			{
				...
				if (rangeAttr != null)
				{
					TextBox1.Attributes.Add("maxlength", rangeAttr.Maximum.ToString().Length.ToString());
					TextBox1.Attributes.Add("min", rangeAttr.Minimum.ToString());
					TextBox1.Attributes.Add("max", rangeAttr.Maximum.ToString());
					TextBox1.Attributes.Add("data-val-range", rangeAttr.ErrorMessage == null ? ValidationConstants.Validation_Length_DefaultError : rangeAttr.ErrorMessage);
