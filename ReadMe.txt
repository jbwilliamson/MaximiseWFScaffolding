...
2. Right-click MaximiseWFScaffolding.vsix and select Set as StartUp Project

3. Open Project Properties for MaximiseWFScaffolding.vsix and select the Debug tab.
...
Maximise Web Forms Scaffolding VSIX installed.
